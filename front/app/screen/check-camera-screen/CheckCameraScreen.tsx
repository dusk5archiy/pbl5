    ...
    <div className="flex flex-col overflow-auto border border-gray-500 rounded w-[30vw] whitespace-nowrap">
      {cameras.map((camera) => (
        <div
          ...
          className={`px-[2vw] py-[1vw] text-[2vw] ${selectedCamera === camera.deviceId
...
export default function CheckCameraScreen({ selectedCamera, setSelectedCamera, onBack, onNext: onContinue }: CheckCameraScreenProps) {
  ...
  return (
    <div className="flex flex-col gap-4 h-screen bg-gray-100">
      <div className="flex flex-col m-4 grow gap-6">
        <div className="h-full rounded px-[4vw] py-[6vh] bg-white">
          ...
          <div className="flex items-center gap-4 h-[10vh] mb-2">
            ...
            <div className="font-bold text-[2vw]">Thiết lập camera</div>
          </div>
          ...
          <div className="flex justify-center gap-4 mt-4">
            <button onClick={refreshCameras}
              className="px-[4vw] py-[2vw] border-2 border-blue-500 rounded-lg font-bold bg-blue-100 text-gray-800 hover:bg-blue-200 text-[3vw]"
            >
              Làm mới
            </button>
            <button onClick={onContinue}
              className="px-[4vw] py-[2vw] border-2 border-green-500 rounded-lg font-bold bg-green-100 text-gray-800 text-[3vw]"
            >
              Tiếp tục
            </button>
          </div>
